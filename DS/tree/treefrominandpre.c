...
/******************************************************************************************************/
int i=0;
struct node *BuildTree(int inordr[],int preordr[],int start,int end)
{
	if(start>end)
	return NULL;
	int top=preordr[i];
	...
	p->left=BuildTree(inordr,preordr,start,pos-1);
	p->right=BuildTree(inordr,preordr,pos+1,end);
	return p;
}
/******************************************************************************************************/
int main()
{
	...
	struct node *tree = BuildTree(inordr,preordr,0,6);
	inorder(tree);
	printf("\n");
	preorder(tree);
	printf("\n");
